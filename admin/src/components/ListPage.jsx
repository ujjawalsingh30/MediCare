...
import { doctorDetailStyles, doctorListStyles } from '../assets/dummyStyles';
...
const ListPage = () => {
    ...
    // show docotor according to filter
    ...
    // shows all docotor or the filter ones
        ...
        <div className={doctorListStyles.container}>
                ...
                <div className={doctorListStyles.headerTopSection}>
                    <div className={doctorListStyles.headerIconContainer}>
                        <div className={doctorListStyles.headerIcon}>
                            <User size={20} className={doctorListStyles.headerIconContainer} />
                        </div>
            ...
            <main className={doctorListStyles.gridContainer}>
                ...
                {displayed.map((doc) => {
                    ...
                    // const sortedDate = getSortedScheduleDates(scheduleMap);
