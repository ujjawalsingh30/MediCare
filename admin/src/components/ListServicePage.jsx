...
export default function ListServicePage() {
    ...
    // sort the slots as lastest come first by date
    ...
    // convert map-like slots to arrays slots of object
    ...
    // formate the slot for backent ex-DD-MM-YYYY with HH:MM AM/PM
