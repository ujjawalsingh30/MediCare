...
const AddService = ({ serviceId }) => {
    ...
    // User cont select previou year/moth /date . from today
    useEffect(() => {
    ...
    // reset the form back to intial state
    function resetForm() {
        if (imagePreview && imagePreview.startsWith("blob:")) {
            try {
                URL.revokeObjectURL(imagePreview);
    ...
    // convert selected 12Hr component to a Date Object
    ...
    return (
        <div className={addServiceStyles.container.main}>
            <div className={addServiceStyles.toast.container}>
                {toast && (
                    <div className={`${addServiceStyles.toast.toastBase} ${toast.type === "error"
                ...
                <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4'>
                    ...
                    <div>
                        ...
                        <p className={addServiceStyles.header.subtitle}>
                            Create a beautifuk service card with unique time slota
                        </p>
                    </div>
